...
_dd(DiaDanh(
    ...
    duoc_lieu=("huyet_tinh_chi", "bach_van_sam", "hoa_tinh_thach"),
...
_dd(DiaDanh(
    ...
    duoc_lieu=("van_nien_ngoc_toai", "u_dam_lien", "bang_phach"),
...
_dd(DiaDanh(
    ...
    duoc_lieu=("cuu_diep_linh_lan", "u_dam_lien", "tu_phu_linh_chi", "yeu_vuong_cot"),
...
_dd(DiaDanh(
    ...
    duoc_lieu=("van_nien_ngoc_toai", "thien_tam_qua", "long_huyet_thao", "bang_phach", "tinh_ha_sa"),
